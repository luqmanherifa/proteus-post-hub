  ...
  return (
    <section className="">
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
        <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-4xl lg:text-5xl">
          Lorem Postum
        </h1>
        <p className="mb-8 max-w-6xl mx-auto text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48">
